...
export function DraftClient() {
  ...
  const handleLoadSave = (save: Partial<EntrosaSave>) => {
    setActiveSave(save);
    setHasStarted(true);
    setSetup({
      formation: '4-3-3', // Placeholder for layout
  ...
  // --- LANDING PAGE ---
  if (!hasStarted) {
    return <DraftLanding onStart={() => setHasStarted(true)} onLoadSave={handleLoadSave} />;
  }
